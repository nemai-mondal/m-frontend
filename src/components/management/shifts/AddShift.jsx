...
const AddShift = ({ isAddOpen, closeAddShift }) => {
  ...
  const convertTime = (shiftStart, shiftEnd, timezoneValue, convertTimezoneValue) => {
  ...
  const {
    ...
    onSubmit: async (values) => {
      ...
      try {
        const res = await Axios.post("shift/create", payload);
