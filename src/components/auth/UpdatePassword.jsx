...
const UpdatePassword = () => {
  ...
  //variable to store firstlogin from url
  const first_login = searchParams.get("firstLogin");
    ...
    useFormik({
      ...
      onSubmit: async (values) => {
        if (time > Math.floor(new Date().getTime() / 1000)) {
          ...
          toast.error(
            "Time expired. Go to your email click on login button to update your password"
          );
        }
      },
    });
        ...
        <Grid item xs={12} sm={12} md={12} lg={6}>
          <div className="login-left">
            ...
            <div className="form-box">
              <h1 className="heading-1">Update Your Password</h1>
