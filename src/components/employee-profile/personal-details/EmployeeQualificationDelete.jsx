...
const EmployeeQualificationDelete = ({
  isDeleteOpen,
  closeDeleteQualification,
  employeeDetails,
        ...
        <Fade in={isDeleteOpen}>
          <Box className="modalContainer xs delete-modal">
            <Box className="modalBody">
              ...
              >
                <p>{`${deleteQualificationData.qualification}`}</p>
              </Typography>
              ...
              <Stack spacing={2} direction="row" justifyContent="center">
                <Button
                  ...
                  onClick={closeDeleteQualification}
                >
                  Cancel
                </Button>
...
export default EmployeeQualificationDelete;
