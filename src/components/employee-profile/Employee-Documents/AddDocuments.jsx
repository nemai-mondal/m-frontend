...
import { EmployeeDocumentSchema } from "@/validations/EmployeeDocumentSchema";
...
const AddDocuments = ({
  ...
  const checkRelatedTo = (data) => {
    ...
    if (data.value === "My-Self") {
      setFieldValue("related_to", "My-Self");

      setFamilyMember([
        {
          label: `${
            employeeDetails?.honorific ? `${employeeDetails?.honorific} ` : ""
      ...
      setFieldValue("related_to_ids", {
        label: `${
          ...
          employeeDetails?.middle_name ? `${employeeDetails.middle_name} ` : ""
        }${employeeDetails?.last_name || ""}-${
          employeeDetails?.employee_id || ""
        }(You)`,
        value: employeeDetails.id||"",
    ...
    if (data.value === "Dependent") {
      setFieldValue("related_to", "Dependent");
  ...
  const {
    ...
    onSubmit: async (values) => {
      ...
      formData.append("related_to", values.related_to);

      formData.append("related_to_ids", values.related_to_ids.value);
      formData.append("family_id", values.related_to_ids.value);
                ...
                <FormGroup>
                  ...
                  <Box component="div" className="choosefile">
                    <Typography
                      ...
                      id="upload-document"
                    >
                      {values.files ? values.files[0].name : "Choose Files..."}
                    </Typography>
